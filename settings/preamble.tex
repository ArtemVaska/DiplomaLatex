...
\captionsetup[table]{labelfont=bf, textfont=normalfont} % textfont=bf для жирного шрифта в тексте таблиц
\captionsetup[figure]{labelfont=bf, textfont=normalfont} % textfont=bf для жирного шрифта в тексте картинок
